        ...
        with Vertical(id="modal_container"):
            ...
            with Vertical(classes="setting_section"):
                ...
                with Horizontal(classes="modal_row"):
                    yield Label("Body Ratio Threshold:", tooltip="Minimum body-to-total size ratio for valid pattern")
                    yield Input(id="inp_body_ratio", placeholder="0.30")
                    yield Static("(30% minimum body size)", classes="field_note")
                with Horizontal(classes="modal_row"):
                    yield Label("Shadow Ratio Threshold:", tooltip="Minimum shadow-to-body ratio for reversal confirmation")
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="modal_container"):
            ...
            with Vertical(classes="setting_section"):
                ...
                with Horizontal(classes="modal_row"):
                    yield Label("Deviation Threshold (%):", tooltip="How far price must deviate from POC to signal thinness")
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="modal_container"):
            ...
            with Vertical(classes="setting_section"):
                ...
                with Horizontal(classes="modal_row"):
                    yield Label("Drift Threshold (¢):", tooltip="Minimum basis gap to trigger signal")
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="modal_container"):
            ...
            with Vertical(classes="setting_section"):
                ...
                with Horizontal(classes="modal_row"):
                    yield Label("Divergence Intensity:", tooltip="Minimum sentiment divergence score to trigger signal")
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="modal_container"):
            ...
            with Vertical(classes="setting_section"):
                ...
                with Horizontal(classes="modal_row"):
                    yield Label("Loss Streak Trigger:", tooltip="Number of consecutive losses before signal inversion activates")
