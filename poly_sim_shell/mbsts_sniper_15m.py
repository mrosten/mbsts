...
class CobraScanner:
    ...
    def analyze(self, closes_60m, current_price, elapsed):
        ...
        if elapsed > 800: return "WAIT (Time)"
...
class SniperApp(App):
    ...
    def compose(self) -> ComposeResult:
        yield Horizontal(
            ...
            Label(" | 15M WIN: ", classes="timer_text"),
        ...
        yield Horizontal(
            Container(
                ...
                Label("Range 15m: $0", id="p_btc_rng", classes="price_sub"),
        ...
        yield Container(
            ...
            Input(placeholder="Max Price", value="0.95", id="inp_max_price"),
            classes="input_group"
        )
    ...
    async def fetch_market_loop(self):
        try:
            ...
            rem_min = max(1, min(15, (900 - elapsed + 59) // 60))
            ...
            def get_data(app_ref, s_up, s_down):
                ...
                try:
                    ...
                    rem_exact = max(0.5, (900 - elapsed_calc) / 60.0)
    ...
    def _check_tpsl(self):
        ...
        for bet_id, info in curr_bets:
            ...
            # --- WHALE PROTECTION REMOVED FOR 15M ---
            # (Previously prevented trading in last 30s)
    ...
    def update_timer(self):
        if self.market_data["start_ts"]: 
            rem = max(0, 900 - int(time.time() - self.market_data["start_ts"]))
            m, s = divmod(rem, 60)
...
if __name__ == "__main__":
    ...
    default_log = f"logs/sim_log_15M_{datetime.now().strftime('%Y%m%d_%H%M')}.csv"
