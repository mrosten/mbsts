...
def calculate_bollinger_edge(checkpoints):
    """
    Calculate if current price is at Bollinger Band edge.
    Returns True if price is within 10% of upper or lower band.
    Uses 36-period (3 minutes at 5-second intervals) simple moving average with 2 standard deviations.
    """
        ...
        for window_start, group in windows:
            ...
            for i, row in g.iterrows():
                        ...
                        if len(recent_times) >= 3:
                            ...
                            if (has_strong_momentum and 
                                ...
                                if cost <= self.balance:
                                    ...
                                    window_trade["bb_edge"] = calculate_bollinger_edge(checkpoints)
                ...
                if elapsed_sec == 540 and not strategy_triggered:
                    ...
                    at_bb_edge = calculate_bollinger_edge(checkpoints)
                    ...
                    if (drift > DRIFT_THRESHOLD and 
                        ...
                        if cost <= self.balance:
                            ...
                            window_trade["btc_current"] = curr_price
                            window_trade["drift"] = drift
                            window_trade["bb_edge"] = at_bb_edge
...
def main():
    ...
    sim = StrongUptrendSimulation(selected_file, balance)
    sim.run()
