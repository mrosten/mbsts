...
class PulseApp(TradeEngineMixin, App):
    ...
    def __init__(self, sim_broker, live_broker, start_live_mode=False, session_id=None):
        ...
        if self.log_settings["verification_html"]:
            with open(self.html_log_file, "w", encoding="utf-8") as f:
                ...
                f.write("<table><thead><tr><th>Timestamp</th><th>Polymarket Window Link</th><th>Start Strike</th><th>End Strike</th><th>Official Result</th><th>Pulse Result</th><th>Sync Status</th><th>PnL ($)</th><th>Graph</th></tr></thead>")
                f.write("<tbody>\n")
    ...
    def on_unmount(self) -> None:
        ...
        # [REMOVED] Destructive save_settings call. 
        # Persistence is now handled by auto-save triggers during active use.
