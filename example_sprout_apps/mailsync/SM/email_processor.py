...
class EMailProcessor(object):
    ...
    async def do_parse(self):
        ...
        # ic() returns an ImapClient object from call to io_context.lookup()
    ...
    async def do_store(self):
        ...
        self.logger.log(f"message {self.email_id} processed from {self.parsed_email.headers['Return-Path']}")
