...
from example_sprout_apps.mailsync.mailsync import MailSyncApp
from example_sprout_apps.smssync.smssync import SMSSyncApp
...
if __name__ == '__main__':
    ...
    if args.tests:
        ...
        app_loop = asyncio.get_event_loop_policy().new_event_loop()
        asyncio.set_event_loop(app_loop)
        # mail_app_inst = MailSyncApp()

        sms_app_inst = SMSSyncApp()

        # app_loop.run_until_complete(mail_app_inst.start()) 
        app_loop.run_until_complete(sms_app_inst.start())
